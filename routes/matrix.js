...
app.get("/", function (req, res, next) {
  req.getConnection(function (error, conn) {
    conn.query(
      "SELECT * FROM matrixkeputusan join bobot on bobot.id_bobot = matrixkeputusan.id_bobot  join alternatif on alternatif.idalternatif = matrixkeputusan.id_alternatif  join skala on skala.id_skala = matrixkeputusan.id_skala ORDER BY id_matrix DESC",
